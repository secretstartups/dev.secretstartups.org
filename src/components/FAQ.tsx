...
import { HelpCircle, ChevronDown, ChevronUp, Code, Users, Briefcase, GraduationCap, Globe } from 'lucide-react';
    ...
    <Layout>
      <Section className="pt-24 pb-16 bg-gradient-to-br from-secondary/20 to-primary/20 border-b border-border">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="mb-6">Frequently <span className="gradient-text" style={{ color: "#00ffff" }}>Asked Questions</span></h1>
          ...
          <div className="mt-16 bg-[#00ffff]/10 p-8 rounded-lg border border-[#00ffff]/30">
            <div className="text-center">
              ...
              <p className="mb-6 text-muted-foreground">
                Our team is here to help you get started with your journey at SecretStartups.org
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a 
                  href="/signup" 
                  className="inline-block px-6 py-3 bg-[#00ffff] hover:bg-[#00ffff]/80 text-black font-semibold rounded-md transition-colors"
                >
                  Sign Up Free Today
                </a>
              </div>
