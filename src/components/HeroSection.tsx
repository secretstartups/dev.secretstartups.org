      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20 pb-24">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xl md:text-2xl text-foreground/80 mb-8">
            We provide developers with everything needed to generate income
            sooner, from paid apprenticeships, and developer acceleration and
            collaboration tools, to a growing ecosystem of trusted{" "}
            <span className="font-semibold text-primary">building blocks</span>{" "}
            to rapidly go-to-market.
          </p>
