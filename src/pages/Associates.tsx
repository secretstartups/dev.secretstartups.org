      ...
      try {
        ...
        try {
          const apiResponse = await fetch(
            "https://crm.secretstartups.org/api/users"
          );
        ...
        const randomProfiles = getRandomSample(
    ...
    <Layout>
      ...
      <Section className="pt-24 pb-16 bg-gradient-to-br from-secondary/20 to-primary/20 border-b border-border">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="mb-6">
            Join Our <span className="gradient-text">Developer Network</span>
          </h1>
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Show the world what you can do. Join a network of talented
            developers, get matched to paid work, and build your career in tech.
          </p>
      ...
      <Section className="bg-card border-t border-border">
        <div className="mb-12">
          <h2 className="mb-4">
            Meet Our <span className="gradient-text">Associates</span>
          </h2>
          <p className="text-lg text-muted-foreground">
            Meet some of the brilliant minds from our network, randomly selected
            and actively building amazing projects across Africa.
          </p>
        </div>
