    ...
    <Layout>
      ...
      <Section className="pt-24 pb-16 bg-gradient-to-br from-secondary/20 to-primary/20 border-b border-border">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="mb-6">
            Find Your Next <span className="gradient-text">Collaborators</span>
          </h1>
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Join forces with brilliant minds. Our teams of talented developers
            are building innovative solutions across Africa.
          </p>
      ...
      <Section className="bg-gradient-to-br from-primary/20 to-secondary/20 border-t border-border">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="mb-6">
            Ready to <span className="gradient-text">Join Forces</span>?
          </h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Collaborate with talented developers on exciting projects. Join
            SecretStartups and become part of a team.
          </p>
